...
func TestGenerateJSONSchemasFlatObject(t *testing.T) {
	...
	schemaConverter, err := New(&types.Config{
		...
		SpecPath:                  "../samples/swagger3_flat-object.yaml",
	}, logrus.New())
...
// 		BlockAdditionalProperties: false,
// 		JSONSchemaFileExtention:   "jsonschema",
// 		SpecPath:                  "../samples/swagger3_flat-object-with-enum.yaml",
// 	}, logrus.New())
// 	require.NoError(t, err)
...
// 		BlockAdditionalProperties: false,
// 		JSONSchemaFileExtention:   "jsonschema",
// 		SpecPath:                  "../samples/swagger3_array-of-referenced-object.yaml",
// 	}, logrus.New())
// 	require.NoError(t, err)
...
// 		BlockAdditionalProperties: false,
// 		JSONSchemaFileExtention:   "jsonschema",
// 		SpecPath:                  "../samples/swagger3_object-with-pattern.yaml",
// 	}, logrus.New())
// 	require.NoError(t, err)
...
// 		BlockAdditionalProperties: false,
// 		JSONSchemaFileExtention:   "jsonschema",
// 		SpecPath:                  "../samples/swagger3_referenced-object.yaml",
// 	}, logrus.New())
// 	require.NoError(t, err)
...
// 		BlockAdditionalProperties: false,
// 		JSONSchemaFileExtention:   "jsonschema",
// 		SpecPath:                  "../samples/swagger3_flat-object-with-number-options.yaml",
// 	}, logrus.New())
// 	require.NoError(t, err)
